...
class partition_slice {
    ...
    std::optional<uint32_t> partition_row_limit_high_bits() [[version 4.3]] = std::numeric_limits<uint32_t>::max();
};
...
class read_command {
    ...
    std::optional<uint32_t> row_limit_high_bits [[version 4.3]] = std::nullopt;
};
