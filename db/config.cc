...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    , commitlog_use_hard_size_limit(this, "commitlog_use_hard_size_limit", value_status::Used, true,
        "Whether or not to use a hard size limit for commitlog disk usage. Default is true. Disabling this can lead to occasional disk usage peaks, whereas the default can cause latency spikes.\n")
    /* Compaction settings */
    /* Related information: Configuring compaction */
