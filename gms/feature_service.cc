...
constexpr std::string_view features::LARGE_PAGING_STATE = "LARGE_PAGING_STATE";
...
feature_service::feature_service(feature_config cfg) : _config(cfg)
        ...
        , _large_paging_state_feature(*this, features::LARGE_PAGING_STATE) {
}
...
std::set<std::string_view> feature_service::known_feature_set() {
    ...
    std::set<std::string_view> features = {
        ...
        gms::features::UDF,
        gms::features::CDC,
        gms::features::LARGE_PAGING_STATE,
    };
