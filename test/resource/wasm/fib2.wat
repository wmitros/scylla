(module
  ...
  (type (;3;) (func))
  (func $_ZN3fib4fib217h02e7455f0474f28bE (type 0) (param i32) (result i64)
    (local i64)
    i64.const 1
    local.set 1
    block  ;; label = @1
      ...
      loop  ;; label = @2
        ...
        i32.const -3
        i32.add
        call $_ZN3fib4fib217h02e7455f0474f28bE
        local.get 1
        i64.add
        local.set 1
        local.get 0
    ...
    local.get 1)
  (func $fib2 (type 0) (param i32) (result i64)
    (local i32 i64)
    ...
    local.get 1
    local.get 0
    call $_ZN69_$LT$i32$u20$as$u20$scylla_udf..wasm_convertible..WasmConvertible$GT$9from_wasm17hcd7b1cb4456cbe4cE
    call $_ZN3fib4fib217h02e7455f0474f28bE
    i64.store offset=8
    local.get 1
    i32.const 8
    i32.add
    call $_ZN69_$LT$i64$u20$as$u20$scylla_udf..wasm_convertible..WasmConvertible$GT$7to_wasm17h0258b4be15d9a6ecE
    local.set 2
    local.get 1
    i32.const 16
    i32.add
    global.set $__stack_pointer
    local.get 2)
  (func $_ZN69_$LT$i32$u20$as$u20$scylla_udf..wasm_convertible..WasmConvertible$GT$9from_wasm17hcd7b1cb4456cbe4cE (type 1) (param i32) (result i32)
    local.get 0)
  (func $_ZN69_$LT$i64$u20$as$u20$scylla_udf..wasm_convertible..WasmConvertible$GT$7to_wasm17h0258b4be15d9a6ecE (type 0) (param i32) (result i64)
    local.get 0
    i64.load)
  ...
  (func $__wasm_call_dtors (type 3)
    call $dummy
    call $dummy)
  (func $_scylla_malloc (type 1) (param i32) (result i32)
    local.get 0
    call $malloc)
  (func $_scylla_free (type 2) (param i32)
    local.get 0
    call $free)
  (func $fib2.command_export (type 0) (param i32) (result i64)
    local.get 0
    call $fib2
    call $__wasm_call_dtors)
  (func $_scylla_malloc.command_export (type 1) (param i32) (result i32)
    local.get 0
    call $_scylla_malloc
    call $__wasm_call_dtors)
  (func $_scylla_free.command_export (type 2) (param i32)
    local.get 0
    call $_scylla_free
    call $__wasm_call_dtors)
  (table (;0;) 1 1 funcref)
  ...
  (export "fib2" (func $fib2.command_export))
